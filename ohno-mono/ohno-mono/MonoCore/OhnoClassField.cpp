...
namespace ohno
{
	...
	MonoMemberAccess OhnoClassField::GetAccessEnum() const
	{
		...
		{
			case MONO_FIELD_ATTR_PRIVATE:
				return MonoMemberAccess::Private;

			case MONO_FIELD_ATTR_FAM_AND_ASSEM:
				return MonoMemberAccess::ProtectedInternal;

			case MONO_FIELD_ATTR_ASSEMBLY:
				return MonoMemberAccess::Internal;

			case MONO_FIELD_ATTR_FAMILY:
				return MonoMemberAccess::Protected;

			case MONO_FIELD_ATTR_PUBLIC:
				return MonoMemberAccess::Public;
